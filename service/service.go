...
func New(config Config) (*Service, error) {
	...
	var clusterapiClusterController *controller.Cluster
	{
		...
		c := controller.ClusterConfig{
			...
			IgnitionAdditionPaths:      config.Viper.GetStringSlice(config.Flag.Service.Guest.Ignition.AdditionPath),
			IgnitionBasePath:           config.Viper.GetString(config.Flag.Service.Guest.Ignition.BasePath),
